...
kernel: ## Jupyter Kernel registrieren
	. .venv/bin/activate && python -m ipykernel install --user --name vbb_realtime_archive --display-name "Python (vbb_realtime_archive)"
	@echo "✅ Kernel 'vbb_realtime_archive' registriert."
